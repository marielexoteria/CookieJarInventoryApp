...
public class EditCookie extends AppCompatActivity {
    ...
    /** Field to enter the type of the cookie (sweet or salty) */
    ...
    /**
     * Type of cookie. The possible values are:
     * 1 = sweet, 2 = salty.
     */
    ...
    private void insertCookie() {
        ...
        int phoneNumber = Integer.parseInt(supplierPhoneString);
        ...
        /* Inserting the dummy data into the table specified in TABLE_NAME (PetContract.java)
        ...
        */
        ...
        if (newRowId == -1) {
            ...
            Toast.makeText(this, "New cookie added: " + newRowId, Toast.LENGTH_SHORT).show();
        }

        //Logging the newRowId for error checking
        Log.i("EditCookie", "New row ID = " + newRowId);
    }
